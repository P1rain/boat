...
class ObjDecoder(json.JSONDecoder):
    ...
    def object_mapper(self, dict_obj):
        ...
        elif "complete_status" in dict_obj.keys():
            return Attend_Lecture(**dict_obj)
        elif "attitude_time" in dict_obj.keys():
            return Attitude(**dict_obj)
        elif "lectured_time" in dict_obj.keys():
            return Lecture(**dict_obj)
